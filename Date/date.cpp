// The implementation file for defining the instance member functions and helper functions for the date class
#include "date.h"
...
const string Date::daysOfWeek[] = {"Sun", "Mon", "Tues", "Wed", "Thu", "Fri", "Sat"};
